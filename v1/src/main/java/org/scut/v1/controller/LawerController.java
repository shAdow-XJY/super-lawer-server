...
public class LawerController {
    ...
    @ApiOperation("根据id获取律师认证信息")
    @GetMapping("/info/{id}")
    public R getLawerInfo(@PathVariable Integer id, HttpServletRequest request){
        return R.ok().data("info",lawerService.getById(id));
    }
